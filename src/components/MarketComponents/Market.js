...
export default function Market(){
    ...
    return(
        // main div
        <div className="market-mainContainer" id = {theme}> {/*RAMON WORK *** ADD THIS ID = {THEME} HERE*/}
            ...
            <div className="market-searchBox" id = {theme}> {/*RAMON WORK *** ADD THIS ID = {THEME} HERE*/}
                { theme === 'dark' ?
